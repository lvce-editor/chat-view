...
const defaultLoadContentDependencies: LoadContentDependencies<LoadContentState> = {
  ensureBlankProject,
...
export const loadContent = async <TState extends LoadContentState>(
  ...
  savedState: unknown,
  {
    ...
    syncBackendAuth,
    toSummarySession,
  }: LoadContentDependencies<TState> = defaultLoadContentDependencies as LoadContentDependencies<TState>,
): Promise<TState> => {
