...
import { handleClickModelPickerContainer } from '../src/parts/HandleClickModelPickerContainer/HandleClickModelPickerContainer.ts'

test('handleClickModelPickerContainer should close model picker and focus composer', async () => {
  ...
  const result = await handleClickModelPickerContainer(state)
