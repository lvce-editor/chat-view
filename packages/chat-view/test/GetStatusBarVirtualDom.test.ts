...
test('getStatusBarVirtualDom should render root chat container', () => {
  const result = GetStatusBarVirtualDom.getChatVirtualDom([], '', '', '', 'list', models, 'test', false, 0, 0, '', 'idle', 28, 13, 'system-ui', 20, 0, 0)
...
test('getStatusBarVirtualDom should render session list entries', () => {
  ...
  const result = GetStatusBarVirtualDom.getChatVirtualDom(sessions, 'session-1', '', '', 'list', models, 'test', false, 0, 0, '', 'idle', 28, 13, 'system-ui', 20, 0, 0)
...
test('getStatusBarVirtualDom should render composer textarea', () => {
  ...
  const result = GetStatusBarVirtualDom.getChatVirtualDom(sessions, 'session-1', 'hello', '', 'detail', models, 'test', false, 0, 0, '', 'idle', 28, 13, 'system-ui', 20, 0, 0)
  const composer = result.find((node) => node.name === 'composer')
  const sendButton = result.find((node) => node.name === 'send')
  expect(composer).toBeDefined()
  expect(sendButton).toBeDefined()
...
test('getStatusBarVirtualDom should render message rows for selected session', () => {
  ...
  const result = GetStatusBarVirtualDom.getChatVirtualDom(sessions, 'session-1', '', '', 'detail', models, 'test', false, 0, 0, '', 'idle', 28, 13, 'system-ui', 20, 0, 0)
...
test('getStatusBarVirtualDom should render OpenRouter api key input and save button for missing key message', () => {
  ...
  const result = GetStatusBarVirtualDom.getChatVirtualDom(sessions, 'session-1', '', 'or-key-typed', 'detail', models, 'test', false, 0, 0, '', 'idle', 28, 13, 'system-ui', 20, 0, 0)
...
test('getStatusBarVirtualDom should not render token usage overview when disabled', () => {
  const sessions = [{ id: 'session-1', messages: [], title: 'Chat 1' }]
  const result = GetStatusBarVirtualDom.getChatVirtualDom(sessions, 'session-1', '', '', 'detail', models, 'test', false, 100, 1000, '', 'idle', 28, 13, 'system-ui', 20, 0, 0)
...
test('getStatusBarVirtualDom should render token usage overview when enabled', () => {
  const sessions = [{ id: 'session-1', messages: [], title: 'Chat 1' }]
  const result = GetStatusBarVirtualDom.getChatVirtualDom(sessions, 'session-1', '', '', 'detail', models, 'test', true, 100, 1000, '', 'idle', 28, 13, 'system-ui', 20, 0, 0)
