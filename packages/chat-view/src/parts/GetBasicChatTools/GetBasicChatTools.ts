...
const getReadFileTool = (): ChatTool => {
  return {
    function: {
      description:
        'Read UTF-8 text content from a file inside the currently open workspace folder. Only pass an absolute URI. For custom UI in responses, do not call a tool: emit <custom-ui><html>...</html><css>...</css></custom-ui> directly in assistant text.',
      name: 'read_file',
      parameters: {
