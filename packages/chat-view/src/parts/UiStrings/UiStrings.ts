...
export const PickModel = 'Pick Model'
export const SearchChats = 'Search chats'
export const MarkAllAsRead = 'Mark All as Read'
...
export const LoggingOutFromBackend = 'Logging out from backend'
export const SignedIn = 'Signed in'
...
export const OpenInVsCode = 'Open in VSCode'
export const Commit = 'Commit'
export const OpenTerminal = 'Open Terminal'
export const ShowDiff = 'Show Diff'
export const CreatePullRequest = 'Create PR'
